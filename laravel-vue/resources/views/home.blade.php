...
<script>
        ...
        var Per = setInterval(myPer, 10000);
        ...
        function myPer() {
              ...
              .done(function(result){
                ...
                if(result==1)
                {
                  ...
                  window.location = "/laravel-vue/public/home";
                  
                }else{
                  window.location = "/laravel-vue/public/";
                }
              });
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">QR-check</a>
        <div id="div1"></div>
